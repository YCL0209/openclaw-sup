---
name: create-order
description: ERP 訂單建立系統。互動式訂單建立工具，通過自然語言解析客戶資訊、品項、數量等，自動連接公司 ERP 系統的 REST API 建立訂單。支持查詢客戶、確認訂單詳情、處理未知客戶等完整流程。用於遠端手機 Clawdbot 與本地 ERP 系統的無縫集成。
---
